...
class MCQSingleCorrect extends React.Component {
    constructor(props) {
        super(props);
                ...
                <div className='mcq-options'>
                    <h3 className='gray'>Options</h3>
                    {
                        this.state.mcqOptions.map((d, k) => {
                            return <label key={k}>
                                <input type='radio' name='mcqOption' defaultValue={d.optionId} defaultChecked={d.selected}/>
                                <span>
...
export default MCQSingleCorrect;